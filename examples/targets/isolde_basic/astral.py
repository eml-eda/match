...
class Astral(MatchTarget):
    ...
    def set_paths(self):
        ...
        self.other_files_to_copy = [
            ...
            os.path.dirname(__file__)+"/config/correct_link_pulpd.ld",
        ]
    ...
    def set_apis(self):
        # profiling ones
        self.start_get_timestamp_api = "astral_get_cycleno"
        self.end_get_timestamp_api = "astral_get_cycleno"
