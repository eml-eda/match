...
def get_results(name_exp, targets, base_dir, directions, models, results_file):
...
if __name__ == "__main__":
    ...
    if any(target not in ["gap", "popen"] for target in args.targets):
        raise ValueError("Targets must be one of 'gap' or 'popen'.")
